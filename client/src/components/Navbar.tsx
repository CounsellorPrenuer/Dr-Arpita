...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "Coaching", id: "coaching", type: "scroll" as const },
    { name: "Programs", id: "programs", type: "scroll" as const },
    { name: "Pricing", href: "/pricing", type: "route" as const },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center gap-3 cursor-pointer group" data-testid="link-logo">
