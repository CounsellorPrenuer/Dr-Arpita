...
import type { Booking, Contact, Payment, Download as DownloadType, BlogPost } from "@shared/schema";
...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: "BLOG POSTS", value: stats?.blogPosts || 0, icon: FileText, bgColor: "bg-blue-600", testId: "stat-blog-posts" },
    ...
    { label: "TOTAL RECORDS", value: stats?.totalRecords || 0, icon: FolderOpen, bgColor: "bg-slate-700", testId: "stat-total-records" },
  ];
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="flex items-center justify-between mb-6">
              <TabsList className="bg-white border" data-testid="tabs-list">
                <TabsTrigger value="customer-data" data-testid="tab-customer-data">
                  <Users className="w-4 h-4 mr-2" />
                  Customer Data
                </TabsTrigger>
                <TabsTrigger value="blog-management" data-testid="tab-blog-management">
